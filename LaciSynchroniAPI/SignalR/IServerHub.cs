...
using LaciSynchroni.API.Dto;
using LaciSynchroni.API.Dto.CharaData;
using LaciSynchroni.API.Dto.Group;
using LaciSynchroni.API.Dto.User;

namespace LaciSynchroni.API.SignalR;

public interface IServerHub
{
    const int ApiVersion = 33;
    const string Path = "/hub";
